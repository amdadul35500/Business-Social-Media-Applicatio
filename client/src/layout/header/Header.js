        ...
        <div className="container-fluid">
          <div className="row header-row">
            <div className="col-md-7 col-4">
              <div className="header-col-7-flex">
                <NavLink to="/">
                  <svg
                ...
                <div className="search-bar">
                  <SearchIcon
                    style={{ color: "#c5c5c5", background: "transparent" }}
                  />
                  <input type="text" />
                </div>
              </div>
            ...
            <div className="col-md-5 col-8">
              <div className="header-col-5-flex">
                <div>
                  <NavLink to="/">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24.556"
                      viewBox="0 0 25 27.556"
                      style={{ cursor: "pointer" }}
                    >
                      <g
                        id="Group_12"
                        data-name="Group 12"
                        transform="translate(-672 -26.444)"
                      >
                        <path
                          id="Vector"
                          d="M0,8.944,11.5,0,23,8.944V23a2.556,2.556,0,0,1-2.556,2.556H2.556A2.556,2.556,0,0,1,0,23Z"
                          transform="translate(673 27.444)"
                          fill="none"
                          stroke="#5a5a5a"
                        ...
                        <path
                          id="Vector-2"
                          data-name="Vector"
                          d="M0,12.778V0H7.667V12.778"
                          transform="translate(680.667 40.222)"
                          fill="none"
                          stroke="#5a5a5a"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                ...
                <div className="add-icon-f-r">
                  <NavLink to="/follow">
                    <PersonAddAltIcon className="add-icon-f-r-2" />
                  </NavLink>
                </div>
                <div>
                  <NavLink to="/messenger">
                    <svg
                      ...
                      width="27.414"
                      height="27.414"
                      viewBox="0 0 29.414 28.414"
                      style={{ cursor: "pointer", color: "#5A5A5A" }}
                    >
                      <g
                        id="Group_14"
                        data-name="Group 14"
                        transform="translate(-801 -25.586)"
                      >
                        <path
                          id="Vector"
                          d="M14.85,0,0,14.3"
                          transform="translate(814.15 27)"
                          fill="none"
                          stroke="#5a5a5a"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        ...
                        <path
                          id="Vector-2"
                          data-name="Vector"
                          d="M27,0,17.55,26l-5.4-11.7L0,9.1Z"
                          transform="translate(802 27)"
                          fill="none"
                          stroke="#5a5a5a"
                          stroke-linecap="round"
                          stroke-linejoin="round"
